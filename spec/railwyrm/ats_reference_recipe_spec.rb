...
RSpec.describe "ATS reference recipe" do
  ...
  it "ships real starter ats view overlays and seeds" do
    expected_files = [
      ...
      "recipes/ats/templates/views/ats/candidates/new.html.erb",
      "recipes/ats/templates/views/ats/candidates/edit.html.erb",
      "recipes/ats/templates/views/ats/pipeline_board/show.html.erb",
      "recipes/ats/templates/views/ats/reports/index.html.erb",
      "recipes/ats/templates/views/ats/job_postings/new.html.erb",
      "recipes/ats/templates/views/ats/job_postings/edit.html.erb",
      "recipes/ats/templates/views/ats/applications/show.html.erb",
      "recipes/ats/templates/views/ats/departments/index.html.erb",
      ...
      "recipes/ats/templates/policies/ats_application_policy.rb",
      "recipes/ats/templates/controllers/ats/teams_controller.rb",
      "recipes/ats/templates/controllers/public/applications_controller.rb",
      "recipes/ats/templates/spec/policies/job_posting_policy_spec.rb",
      "recipes/ats/templates/spec/system/ats/hiring_flow_spec.rb",
